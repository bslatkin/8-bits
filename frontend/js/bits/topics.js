...
/**
 * Types of events generated by TopicPrompts.
 * @enum {string}
 */
bits.topics.TopicPrompt.EventType = {
  // The user has indicated to the topic prompt that they no longer want
  // to continue creating a new topic.
  Cancel: 'Cancel',
  // The user has finished providing all the information necessary to
  // start a topic.
  Done: 'Done'
};
...
bits.topics.TopicPrompt.prototype.enterDocument = function() {
  ...
  bits.events.PubSub.subscribe(
      this.shardId_, bits.events.EventType.SubmitTopicLink,
 ...
 *
 */
bits.topics.TopicPrompt.prototype.stop = function(link) {
  this.pendingLink_ = null;
